(ns marketentry.marketentryllm
  ...
  the South Sudan (SSD) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "external-beneficiary-procurement?=" (:external-beneficiary-procurement? e)
                        " contractor-registered-in-south-sudan?=" (:contractor-registered-in-south-sudan? e)
                        " insurer-registered-in-south-sudan?=" (:insurer-registered-in-south-sudan? e)
                        " carriage-registered-in-south-sudan?=" (:carriage-registered-in-south-sudan? e)
