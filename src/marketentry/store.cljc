(ns marketentry.store
  "SSoT for the South Sudan (SSD) market-entry compliance actor, behind
...
(defn demo-data
  ...
  `:external-beneficiary-procurement?` /
  `:contractor-registered-in-south-sudan?` /
  `:insurer-registered-in-south-sudan?` /
  `:carriage-registered-in-south-sudan?` are ground truth for the
  `external-beneficiary-registration-noncompliant` flagship check
  (Public Procurement and Disposal of Assets Act, 2018, Section 4(7)-
  (8)); `:requires-tin-record?` / `:tin-record-verified?` are ground
  truth for the conditional Ministry of Finance TIN check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Juba Logistics Ltd" :portal "eservices.gov.ss/investment"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :external-beneficiary-procurement? false
             :contractor-registered-in-south-sudan? false
             ...
             :jurisdiction "SSD" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "eservices.gov.ss/investment"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :external-beneficiary-procurement? false
             :contractor-registered-in-south-sudan? false
    ...
    "eng-3" {:id "eng-3" :operator "Nile Basin Contractors Co" :portal "eservices.gov.ss/investment"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SSD" :status :intake}
    "eng-4" {:id "eng-4" :operator "Bahr el Ghazal Supplies Co" :portal "eservices.gov.ss/investment"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "SSD" :status :intake}
    "eng-5" {:id "eng-5" :operator "Equatoria Freight Services" :portal "eservices.gov.ss/investment"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :external-beneficiary-procurement? false
             :contractor-registered-in-south-sudan? false
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? external-beneficiary-procurement?) (assoc :engagement/external-beneficiary-procurement? external-beneficiary-procurement?)
    (some? contractor-registered-in-south-sudan?) (assoc :engagement/contractor-registered-in-south-sudan? contractor-registered-in-south-sudan?)
    (some? insurer-registered-in-south-sudan?)    (assoc :engagement/insurer-registered-in-south-sudan? insurer-registered-in-south-sudan?)
    (some? carriage-registered-in-south-sudan?)   (assoc :engagement/carriage-registered-in-south-sudan? carriage-registered-in-south-sudan?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/external-beneficiary-procurement?
   :engagement/contractor-registered-in-south-sudan?
   :engagement/insurer-registered-in-south-sudan?
   :engagement/carriage-registered-in-south-sudan?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :external-beneficiary-procurement? (boolean (:engagement/external-beneficiary-procurement? m))
     :contractor-registered-in-south-sudan? (boolean (:engagement/contractor-registered-in-south-sudan? m))
     :insurer-registered-in-south-sudan? (boolean (:engagement/insurer-registered-in-south-sudan? m))
     :carriage-registered-in-south-sudan? (boolean (:engagement/carriage-registered-in-south-sudan? m))
