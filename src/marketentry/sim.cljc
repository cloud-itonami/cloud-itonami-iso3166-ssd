...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (SSD, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up external-beneficiary-registration-noncompliant) ==")
    ...
    (println "== filing/submit eng-4 (external-beneficiary-registration-noncompliant -> HARD hold) ==")
